...
def generate_liquid_handler_notebook(
    ...
    helper_functions = [
        ...
        '    await lh.pick_up_tips(lh.deck.get_resource("main_tips")[target_well])\n',
        ...
        "    plate = lh.deck.get_resource(plate_name)\n",
        "    tip_positions = [f\"{chr(ord('A') + idx)}{column_number}\" for idx in channel_indices]\n",
        "    tips = [lh.deck.get_resource(\"main_tips\")[pos] for pos in tip_positions]\n",
        ...
        "    targets = [plate[pos] for pos in tip_positions]\n",
        ...
        "    tip_resources = [lh.deck.get_resource(\"main_tips\")[pos] for pos in target_positions]\n",
        "    if change_tips:\n",
        "        await lh.pick_up_tips(tip_resources)\n",
        "    else:\n",
        "        if not reuse_state.get(\"loaded\"):\n",
        "            await lh.pick_up_tips(tip_resources)\n",
